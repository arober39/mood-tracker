...
@dso_cache = dso_local local_unnamed_addr global [44 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x0f97e6f5b95f443f, ; from name: session_replay_c.so
		i64 u0xf79f06b28113b2cc, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.0_name, ; name: libsession_replay_c.so
		ptr null; void* handle
	}, ; 4
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x4820ecea2e6f7f4f, ; from name: session_replay_c
		i64 u0xf79f06b28113b2cc, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.0_name, ; name: libsession_replay_c.so
	...
	%struct.DSOCacheEntry {
		i64 u0x499f04f2ac0b6fce, ; from name: libsession_replay_c
		i64 u0xf79f06b28113b2cc, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.0_name, ; name: libsession_replay_c.so
	...
	%struct.DSOCacheEntry {
		i64 u0xf79f06b28113b2cc, ; from name: libsession_replay_c.so
		i64 u0xf79f06b28113b2cc, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.0_name, ; name: libsession_replay_c.so
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"com.companyname.moodtracker\00", align 1

;DSOCacheEntry
@.DSOCacheEntry.0_name = private unnamed_addr constant [23 x i8] c"libsession_replay_c.so\00", align 1
