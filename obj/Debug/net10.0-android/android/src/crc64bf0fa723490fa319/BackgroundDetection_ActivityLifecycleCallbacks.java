package crc64bf0fa723490fa319;


public class BackgroundDetection_ActivityLifecycleCallbacks
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("LaunchDarkly.Sdk.Client.PlatformSpecific.BackgroundDetection+ActivityLifecycleCallbacks, LaunchDarkly.ClientSdk", BackgroundDetection_ActivityLifecycleCallbacks.class, __md_methods);
	}

	public BackgroundDetection_ActivityLifecycleCallbacks ()
	{
		super ();
		if (getClass () == BackgroundDetection_ActivityLifecycleCallbacks.class) {
			mono.android.TypeManager.Activate ("LaunchDarkly.Sdk.Client.PlatformSpecific.BackgroundDetection+ActivityLifecycleCallbacks, LaunchDarkly.ClientSdk", "", this, new java.lang.Object[] {  });
		}
	}
